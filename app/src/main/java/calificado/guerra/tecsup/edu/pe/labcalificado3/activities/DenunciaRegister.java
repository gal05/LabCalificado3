...
public class DenunciaRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mostrarGPS= (TextView) findViewById(R.id.coordenadas_show);
        captureGPS = (Button) findViewById(R.id.catchCoordenadas);
        ...
        listener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mostrarGPS.setText(location.getLongitude() + " " + location.getLatitude());
            }
...
/**
 *https://github.com/miskoajkula/Gps_location.git
 */
/**
 *https://github.com/modelkit62/GeoAndroid.git----> :v
 */